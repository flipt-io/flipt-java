...
@JsonDeserialize(builder = RuleList.Builder.class)
public final class RuleList {
    ...
    private RuleList(List<Rule> rules, String nextPageToken, int totalCount) {
        this.rules = rules;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.rules, this.nextPageToken, this.totalCount);
    }
