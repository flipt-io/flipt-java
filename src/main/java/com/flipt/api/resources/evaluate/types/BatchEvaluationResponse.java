...
@JsonDeserialize(builder = BatchEvaluationResponse.Builder.class)
public final class BatchEvaluationResponse {
    ...
    private BatchEvaluationResponse(
            String requestId, List<EvaluationResponse> responses, double requestDurationMillis) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.requestId, this.responses, this.requestDurationMillis);
    }

    @Override
    public String toString() {
        return "BatchEvaluationResponse{" + "requestId: " + requestId + ", responses: " + responses
