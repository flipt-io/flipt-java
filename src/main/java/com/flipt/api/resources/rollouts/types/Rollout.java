...
@JsonDeserialize(builder = Rollout.Builder.class)
public final class Rollout {
    ...
    public String toString() {
        return "Rollout{" + "id: " + id + ", namespaceKey: " + namespaceKey + ", flagKey: " + flagKey + ", type: "
                + type + ", rank: " + rank + ", description: " + description + ", createdAt: " + createdAt
                + ", updatedAt: " + updatedAt + ", segment: " + segment + ", threshold: " + threshold + "}";
    }
    ...
    public static final class Builder
        ...
        public Rollout build() {
            return new Rollout(
                    id, namespaceKey, flagKey, type, rank, description, createdAt, updatedAt, segment, threshold);
        }
    }
}
