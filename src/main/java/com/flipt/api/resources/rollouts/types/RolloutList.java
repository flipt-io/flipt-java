...
@JsonDeserialize(
    builder = RolloutList.Builder.class
)
public final class RolloutList {
  ...
  RolloutList(List<Rollout> rollouts, String nextPageToken, int totalCount) {
  ...
  private boolean equalTo(RolloutList other) {
    return rollouts.equals(other.rollouts) && nextPageToken.equals(other.nextPageToken) && totalCount == other.totalCount;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.rollouts, this.nextPageToken, this.totalCount);
    }
  ...
  public String toString() {
    return "RolloutList{" + "rollouts: " + rollouts + ", nextPageToken: " + nextPageToken + ", totalCount: " + totalCount + "}";
  }
