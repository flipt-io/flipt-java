...
@JsonDeserialize(
    builder = RolloutCreateRequest.Builder.class
)
public final class RolloutCreateRequest {
  ...
  RolloutCreateRequest(int rank, Optional<String> description, Optional<RolloutSegment> segment,
  ...
  private boolean equalTo(RolloutCreateRequest other) {
    return rank == other.rank && description.equals(other.description) && segment.equals(other.segment) && threshold.equals(other.threshold);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.rank, this.description, this.segment, this.threshold);
    }
  ...
  public String toString() {
    return "RolloutCreateRequest{" + "rank: " + rank + ", description: " + description + ", segment: " + segment + ", threshold: " + threshold + "}";
  }
