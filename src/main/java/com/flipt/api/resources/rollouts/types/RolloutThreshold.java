...
@JsonDeserialize(
    builder = RolloutThreshold.Builder.class
)
public final class RolloutThreshold {
  ...
  RolloutThreshold(double percentage, boolean value) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.percentage, this.value);
    }
  ...
  public String toString() {
    return "RolloutThreshold{" + "percentage: " + percentage + ", value: " + value + "}";
  }
