package com.flipt.api.resources.variants.requests;
...
@JsonDeserialize(
    builder = VariantUpdateRequest.Builder.class
)
public final class VariantUpdateRequest {
  ...
  VariantUpdateRequest(String key, Optional<String> name, Optional<String> description,
  ...
  public String toString() {
    return "VariantUpdateRequest{" + "key: " + key + ", name: " + name + ", description: " + description + ", attachment: " + attachment + "}";
  }
