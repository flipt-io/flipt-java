...
public final class Variant {
    ...
    public String toString() {
        return "Variant{" + "id: " + id + ", namespaceKey: " + namespaceKey + ", flagKey: " + flagKey + ", key: " + key
                + ", name: " + name + ", description: " + description + ", createdAt: " + createdAt + ", updatedAt: "
                + updatedAt + ", attachment: " + attachment + "}";
    }
