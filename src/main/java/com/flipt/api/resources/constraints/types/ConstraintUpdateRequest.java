...
@JsonDeserialize(
    builder = ConstraintUpdateRequest.Builder.class
)
public final class ConstraintUpdateRequest {
  ...
  ConstraintUpdateRequest(ConstraintComparisonType type, String property, String operator,
  ...
  public String toString() {
    return "ConstraintUpdateRequest{" + "type: " + type + ", property: " + property + ", operator: " + operator + ", value: " + value + ", description: " + description + "}";
  }
