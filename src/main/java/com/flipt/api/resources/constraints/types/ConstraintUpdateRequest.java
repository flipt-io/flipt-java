...
public final class ConstraintUpdateRequest {
  ...
  public String toString() {
    return "ConstraintUpdateRequest{" + "type: " + type + ", property: " + property + ", operator: " + operator + ", value: " + value + "}";
  }
  ...
  public static final class Builder implements TypeStage, PropertyStage, OperatorStage, _FinalStage {
    ...
    public ConstraintUpdateRequest build() {
      return new ConstraintUpdateRequest(type, property, operator, value);
    }
  }
}
