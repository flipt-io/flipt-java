...
@JsonDeserialize(builder = ConstraintCreateRequest.Builder.class)
public final class ConstraintCreateRequest {
    ...
    private ConstraintCreateRequest(
    ...
    public String toString() {
        return "ConstraintCreateRequest{" + "type: " + type + ", property: " + property + ", operator: " + operator
