...
@JsonDeserialize(
    builder = ErrorEvaluationResponse.Builder.class
)
public final class ErrorEvaluationResponse {
  ...
  ErrorEvaluationResponse(String flagKey, String namespaceKey, ErrorEvaluationReason reason) {
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.flagKey, this.namespaceKey, this.reason);
    }
  ...
  public String toString() {
    return "ErrorEvaluationResponse{" + "flagKey: " + flagKey + ", namespaceKey: " + namespaceKey + ", reason: " + reason + "}";
  }
