...
public final class EvaluationRequest {
  ...
  EvaluationRequest(Optional<String> requestId, String namespaceKey, String flagKey,
      String entityId, Map<String, String> context) {
  ...
  private boolean equalTo(EvaluationRequest other) {
    return requestId.equals(other.requestId) && namespaceKey.equals(other.namespaceKey) && flagKey.equals(other.flagKey) && entityId.equals(other.entityId) && context.equals(other.context);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.requestId, this.namespaceKey, this.flagKey, this.entityId, this.context);
    }
  ...
  public String toString() {
    return "EvaluationRequest{" + "requestId: " + requestId + ", namespaceKey: " + namespaceKey + ", flagKey: " + flagKey + ", entityId: " + entityId + ", context: " + context + "}";
  }
