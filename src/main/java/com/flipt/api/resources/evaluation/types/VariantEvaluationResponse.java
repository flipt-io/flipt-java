...
@JsonDeserialize(builder = VariantEvaluationResponse.Builder.class)
public final class VariantEvaluationResponse {
    ...
    public String toString() {
        return "VariantEvaluationResponse{" + "requestId: " + requestId + ", match: " + match + ", segmentKeys: "
                + segmentKeys + ", variantKey: " + variantKey + ", variantAttachment: " + variantAttachment
                + ", timestamp: " + timestamp + ", requestDurationMillis: " + requestDurationMillis + ", reason: "
                + reason + "}";
    }
