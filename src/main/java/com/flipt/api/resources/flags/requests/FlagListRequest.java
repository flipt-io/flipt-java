...
@JsonDeserialize(
    builder = FlagListRequest.Builder.class
)
public final class FlagListRequest {
  ...
  FlagListRequest(Optional<Integer> limit, Optional<Integer> offset, Optional<String> pageToken) {
    this.limit = limit;
    this.offset = offset;
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FlagListRequest && equalTo((FlagListRequest) other);
  }
  ...
  public String toString() {
    return "FlagListRequest{" + "limit: " + limit + ", offset: " + offset + ", pageToken: " + pageToken + "}";
  }
