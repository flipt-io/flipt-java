...
import com.flipt.api.resources.flags.requests.FlagGetRequest;
...
public class FlagsClient {
    ...
    public Flag get(String namespaceKey, String key) {
        return get(namespaceKey, key, FlagGetRequest.builder().build());
    }

    public Flag get(String namespaceKey, String key, FlagGetRequest request, RequestOptions requestOptions) {
        HttpUrl.Builder httpUrl = HttpUrl.parse(this.clientOptions.environment().getUrl())
                .newBuilder()
                .addPathSegments("api/v1/namespaces")
                .addPathSegment(namespaceKey)
    ...
    public Flag get(String namespaceKey, String key, FlagGetRequest request) {
