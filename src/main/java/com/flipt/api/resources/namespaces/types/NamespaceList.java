...
@JsonDeserialize(
    builder = NamespaceList.Builder.class
)
public final class NamespaceList {
  ...
  NamespaceList(List<Namespace> namespaces, String nextPageToken, int totalCount) {
  ...
  private boolean equalTo(NamespaceList other) {
    return namespaces.equals(other.namespaces) && nextPageToken.equals(other.nextPageToken) && totalCount == other.totalCount;
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.namespaces, this.nextPageToken, this.totalCount);
    }
  ...
  public String toString() {
    return "NamespaceList{" + "namespaces: " + namespaces + ", nextPageToken: " + nextPageToken + ", totalCount: " + totalCount + "}";
  }
