...
@JsonDeserialize(
    builder = OidcCallbackRequest.Builder.class
)
public final class OidcCallbackRequest {
  ...
  OidcCallbackRequest(String code, String state) {
    this.code = code;
    this.state = state;
  }
  ...
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.code, this.state);
    }
  ...
  public String toString() {
    return "OidcCallbackRequest{" + "code: " + code + ", state: " + state + "}";
  }
