...
@JsonDeserialize(builder = AuthenticationList.Builder.class)
public final class AuthenticationList {
    private final List<Authentication> authentications;

    private final String nextPageToken;

    private AuthenticationList(List<Authentication> authentications, String nextPageToken) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(this.authentications, this.nextPageToken);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage addAuthentications(Authentication authentications);
    ...
    public static final class Builder implements NextPageTokenStage, _FinalStage {
        ...
        @Override
        public _FinalStage addAuthentications(Authentication authentications) {
