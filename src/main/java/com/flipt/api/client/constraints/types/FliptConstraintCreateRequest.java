...
@JsonDeserialize(
    builder = FliptConstraintCreateRequest.Builder.class
)
public final class FliptConstraintCreateRequest {
  ...
  FliptConstraintCreateRequest(FliptComparisonType type, String property, String operator,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FliptConstraintCreateRequest && equalTo((FliptConstraintCreateRequest) other);
  }

  private boolean equalTo(FliptConstraintCreateRequest other) {
  ...
  public String toString() {
    return "FliptConstraintCreateRequest{" + "type: " + type + ", property: " + property + ", operator: " + operator + ", value: " + value + "}";
  }
  ...
  public interface TypeStage {
    ...
    Builder from(FliptConstraintCreateRequest other);
  }
  ...
  public interface _FinalStage {
    FliptConstraintCreateRequest build();
  ...
  static final class Builder implements TypeStage, PropertyStage, OperatorStage, _FinalStage {
    ...
    @Override
    public Builder from(FliptConstraintCreateRequest other) {
      type(other.getType());
    ...
    @Override
    public FliptConstraintCreateRequest build() {
      return new FliptConstraintCreateRequest(type, property, operator, value);
    }
  }
}
