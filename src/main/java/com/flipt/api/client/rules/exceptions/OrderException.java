...
@JsonDeserialize(
    using = OrderException.Deserializer.class
)
public final class OrderException extends Exception {
  ...
  private OrderException(Value value, int statusCode) {
    this.value = value;
  ...
  public static OrderException other(Object unknownValue, int statusCode) {
    return new OrderException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "OrderException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<OrderException> {
    @Override
    public OrderException deserialize(JsonParser p, DeserializationContext ctx) throws IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new OrderException(value, statusCode);
    }
  }
}
