...
@JsonDeserialize(
    builder = FliptVariantCreate.Builder.class
)
public final class FliptVariantCreate {
  ...
  FliptVariantCreate(String key, Optional<String> name, Optional<String> description,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FliptVariantCreate && equalTo((FliptVariantCreate) other);
  }

  private boolean equalTo(FliptVariantCreate other) {
  ...
  public String toString() {
    return "FliptVariantCreate{" + "key: " + key + ", name: " + name + ", description: " + description + ", attachment: " + attachment + "}";
  }
  ...
  public interface KeyStage {
    ...
    Builder from(FliptVariantCreate other);
  }

  public interface _FinalStage {
    FliptVariantCreate build();
  ...
  static final class Builder implements KeyStage, _FinalStage {
    ...
    @Override
    public Builder from(FliptVariantCreate other) {
      key(other.getKey());
      name(other.getName());
    ...
    @Override
    public FliptVariantCreate build() {
      return new FliptVariantCreate(key, name, description, attachment);
    }
  }
}
