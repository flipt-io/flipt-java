...
@JsonDeserialize(
    builder = FliptVariantUpdate.Builder.class
)
public final class FliptVariantUpdate {
  ...
  FliptVariantUpdate(String key, Optional<String> name, Optional<String> description,
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FliptVariantUpdate && equalTo((FliptVariantUpdate) other);
  }

  private boolean equalTo(FliptVariantUpdate other) {
  ...
  public String toString() {
    return "FliptVariantUpdate{" + "key: " + key + ", name: " + name + ", description: " + description + ", attachment: " + attachment + "}";
  }
  ...
  public interface KeyStage {
    ...
    Builder from(FliptVariantUpdate other);
  }

  public interface _FinalStage {
    FliptVariantUpdate build();
  ...
  static final class Builder implements KeyStage, _FinalStage {
    ...
    @Override
    public Builder from(FliptVariantUpdate other) {
      key(other.getKey());
      name(other.getName());
    ...
    @Override
    public FliptVariantUpdate build() {
      return new FliptVariantUpdate(key, name, description, attachment);
    }
  }
}
