...
public final class ExpireSelf {
  private ExpireSelf() {
  }

  public static final class Request {
    private final AuthenticationExpireSelfRequest body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(AuthenticationExpireSelfRequest body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public AuthenticationExpireSelfRequest getBody() {
      return body;
    }
    ...
    public String toString() {
      return "ExpireSelf.Request{" + "body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(AuthenticationExpireSelfRequest body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private AuthenticationExpireSelfRequest body;
      ...
      @Override
      public _FinalStage body(AuthenticationExpireSelfRequest body) {
        this.body = body;
        return this;
      }
