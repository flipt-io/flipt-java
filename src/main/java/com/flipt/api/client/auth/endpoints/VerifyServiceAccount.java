...
public final class VerifyServiceAccount {
  private VerifyServiceAccount() {
  }

  public static final class Request {
    private final KubernetesVerifyServiceAccount body;

    private final Optional<BearerAuth> authOverride;

    private int _cachedHashCode;

    Request(KubernetesVerifyServiceAccount body, Optional<BearerAuth> authOverride) {
      this.body = body;
      this.authOverride = authOverride;
    }

    public KubernetesVerifyServiceAccount getBody() {
      return body;
    }
    ...
    public String toString() {
      return "VerifyServiceAccount.Request{" + "body: " + body + ", authOverride: " + authOverride + "}";
    }
    ...
    public interface BodyStage {
      _FinalStage body(KubernetesVerifyServiceAccount body);
    ...
    public static final class Builder implements BodyStage, _FinalStage {
      private KubernetesVerifyServiceAccount body;
      ...
      @Override
      public _FinalStage body(KubernetesVerifyServiceAccount body) {
        this.body = body;
        return this;
      }
