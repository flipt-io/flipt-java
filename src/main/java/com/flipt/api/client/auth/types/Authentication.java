...
@JsonDeserialize(
    builder = Authentication.Builder.class
)
public final class Authentication {
  ...
  Authentication(String id, AuthenticationMethod method, String createdAt, String updatedAt,
      Optional<String> expiresAt, Map<String, String> metadata) {
    this.id = id;
    this.method = method;
  ...
  private boolean equalTo(Authentication other) {
    return id.equals(other.id) && method.equals(other.method) && createdAt.equals(other.createdAt) && updatedAt.equals(other.updatedAt) && expiresAt.equals(other.expiresAt) && metadata.equals(other.metadata);
  }

  @Override
  public int hashCode() {
    if (_cachedHashCode == 0) {
      _cachedHashCode = Objects.hash(this.id, this.method, this.createdAt, this.updatedAt, this.expiresAt, this.metadata);
    }
  ...
  public String toString() {
    return "Authentication{" + "id: " + id + ", method: " + method + ", createdAt: " + createdAt + ", updatedAt: " + updatedAt + ", expiresAt: " + expiresAt + ", metadata: " + metadata + "}";
  }
