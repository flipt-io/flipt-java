...
@JsonDeserialize(
    using = GetTokenException.Deserializer.class
)
public final class GetTokenException extends Exception {
  ...
  private GetTokenException(Value value, int statusCode) {
    this.value = value;
  ...
  public static GetTokenException other(Object unknownValue, int statusCode) {
    return new GetTokenException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "GetTokenException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<GetTokenException> {
    @Override
    public GetTokenException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new GetTokenException(value, statusCode);
    }
  }
}
