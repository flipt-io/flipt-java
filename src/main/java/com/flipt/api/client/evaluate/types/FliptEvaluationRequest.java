...
@JsonDeserialize(
    builder = FliptEvaluationRequest.Builder.class
)
public final class FliptEvaluationRequest {
  ...
  FliptEvaluationRequest(Optional<String> requestId, String flagKey, String entityId,
      String context) {
  ...
  public boolean equals(Object other) {
    ...
    return other instanceof FliptEvaluationRequest && equalTo((FliptEvaluationRequest) other);
  }

  private boolean equalTo(FliptEvaluationRequest other) {
  ...
  public String toString() {
    return "FliptEvaluationRequest{" + "requestId: " + requestId + ", flagKey: " + flagKey + ", entityId: " + entityId + ", context: " + context + "}";
  }
  ...
  public interface FlagKeyStage {
    ...
    Builder from(FliptEvaluationRequest other);
  }
  ...
  static final class Builder implements FlagKeyStage, EntityIdStage, ContextStage, _FinalStage {
    ...
    @Override
    public Builder from(FliptEvaluationRequest other) {
    ...
    @Override
    public FliptEvaluationRequest build() {
      return new FliptEvaluationRequest(requestId, flagKey, entityId, context);
    }
  }
}
