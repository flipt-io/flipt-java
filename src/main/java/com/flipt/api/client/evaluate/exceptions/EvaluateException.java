...
@JsonDeserialize(
    using = EvaluateException.Deserializer.class
)
public final class EvaluateException extends Exception {
  ...
  private EvaluateException(Value value, int statusCode) {
    this.value = value;
  ...
  public static EvaluateException other(Object unknownValue, int statusCode) {
    return new EvaluateException(new UnknownErrorValue(unknownValue), statusCode);
  }
  ...
  private static final class UnknownErrorValue implements Value {
    ...
    public String toString() {
      return "EvaluateException{" + "unknownValue: " + unknownValue + "}";
    }
  }

  static final class Deserializer extends JsonDeserializer<EvaluateException> {
    @Override
    public EvaluateException deserialize(JsonParser p, DeserializationContext ctx) throws
        IOException {
      Value value = ctx.readValue(p, Value.class);
      int statusCode = (int) ctx.getAttribute("statusCode");
      return new EvaluateException(value, statusCode);
    }
  }
}
